  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['results'] != null) {
      ...
      json['results'].forEach((v) {
        final character = new Character.fromJson(v);
        if (character.description.isNotEmpty && (character.thumbnail != null
            && (character.thumbnail.path.isNotEmpty && character.thumbnail.extension.isNotEmpty))) {
